        ...
        <div class="col-md-4">
            ...
            <form action="alterar.php?id=<?php echo $dados->ID; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <option value="<?php echo$empresa->ID; ?>" <?php if($empresa->ID == $dados->EMPRESA){ echo "selected"; } ?>><?php echo$empresa->NOME; ?></option>
                    <!-- fim do laco foreach -->
                    <?php endforeach; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="departamento" class="form-control" value="<?php echo $dados->DEPARTAMENTO; ?>">
                </div>
                <div class="form-group">
                    <label for="telefone_fixo">Telefone fixo</label>
                    <input type="text" name="telefone_fixo" class="form-control" value="<?php echo $dados->TELEFONE_FIXO; ?>">
                </div>
                <div class="form-group">
                    <label for="telefone_celular">Telefone celular</label>
                    <input type="text" name="telefone_celular" class="form-control" value="<?php echo $dados->TELEFONE_CELULAR; ?>">
                </div>
                <div class="form-group">
