...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <h3>Alterar dados da Ordem de Serviço</h3>
            <form action="alterar.php?id=<?php echo $dados->ID; ?>" method="post">
                
                <div class="form-group">
                    <label for="status_os">Status Os</label>
                    <input type="text" name="status_os" class="form-control" value="<?php echo $dados->STATUS_OS; ?>">
                </div>
                <div class="form-group">
                    <label for="data_abertura">Data de abertura</label>
                    <input type="text" name="data_abertura" class="form-control" value="<?php echo $dados->DATA_ABERTURA; ?>">
                </div>
                <div class="form-group">
                    <label for="hora_abertura">Hora de abertura</label>
                    <input type="text" name="hora_abertura" class="form-control" value="<?php echo $dados->HORA_ABERTURA; ?>">
                </div>
                <div class="form-group">
                    <label for="data_fechamento">Data de fechamento</label>
                    <input type="text" name="data_fechamento" class="form-control" value="<?php echo $dados->DATA_FECHAMENTO; ?>">
                </div>
                <div class="form-group">
                    <label for="hora_fechamento">Hora de fechamento</label>
                    <input type="text" name="hora_fechamento" class="form-control" value="<?php echo $dados->HORA_FECHAMENTO; ?>">
                </div>
                <div class="form-group">
                    ...
                    <option value="<?php echo$categoria->ID; ?>" <?php if($categoria->ID == $dados->CATEGORIA){ echo "selected"; } ?>><?php echo$categoria->NOME; ?></option>
                    <!-- fim do laco foreach -->
                    <?php endforeach; ?>
                ...
                <div class="form-group">
                    ...
                    <option value="<?php echo$clientes->ID; ?>" <?php if($clientes->ID == $dados->CLIENTE){ echo "selected"; } ?>><?php echo$clientes->NOME; ?></option>
                    <!-- fim do laco foreach -->
                    <?php endforeach; ?>
                    <!-- se a variavel dados nao retornou valores -->
                    <?php else : ?>
                ...
                <div class="form-group">
                    ...
                    <option value="<?php echo$tecnicos->ID; ?>" <?php if($tecnicos->ID == $dados->TECNICO_EXECUTANTE){ echo "selected"; } ?>><?php echo$tecnicos->NOME; ?></option>
                    <!-- fim do laco foreach -->
                    <?php endforeach; ?>
                    <!-- se a variavel dados nao retornou valores -->
                    <?php else : ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="descricao" class="form-control" value="<?php echo $dados->DESCRICAO; ?>">
                </div>
                <div class="form-group">
                    <label for="resolucao">Resolução</label>
                    <input type="text" name="resolucao" class="form-control" value="<?php echo $dados->RESOLUCAO; ?>">
                </div>
                <div class="row">
